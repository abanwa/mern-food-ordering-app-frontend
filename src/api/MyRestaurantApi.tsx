...
// WE WILL GET THE ORDERS THAT BEGLONGS TO THE LOGGED IN USER's RESTAURANT FROM THE ORDER TABLE
export const useGetMyRestaurantOrders = () => {
  ...
  const getMyRestaurantOrdersRequest = async (): Promise<Order[]> => {
    ...
    if (!response.ok) {
      throw new Error("ailed to fetch orders");
    }
...
export const useUpdateMyRestaurantOrder = () => {
  ...
  if (isError) {
    ...
    // the reset clears up the error so that it doesn't keep popping up for every rerender of the page
    reset();
  }
